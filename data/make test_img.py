...
def traversalDir_FirstDir(path):
    ...
    if (os.path.exists(path)):
        # Get all files or folders in the directory
        files = os.listdir(path)
        for file in files:
            # Get the path of all directories under the file
...
if __name__ == '__main__':
    ...
    parser.add_argument('--filepath', type=str, default='AgriculturalDisease_testA/', help='img firtst address')
    parser.add_argument('--shuffle', type=bool, default=False, help='file shuffle')
    parser.add_argument('--chunks', type=int, default=1, help='how many img to deal every step')
